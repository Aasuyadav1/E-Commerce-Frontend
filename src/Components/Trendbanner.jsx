...
function Trendbanner() {
  return (
    <div className='flex gap-[20px] justify-center mt-[80px] max-[1000px]:flex-wrap px-[10px] max-[1000px]:gap-[5px]'>
      ...
      <div className='image-hover relative w-full h-full overflow-hidden z-[1]'>
        <div className='content w-full h-full px-[50px] py-[100px] flex flex-col gap-[10px] max-[518px]:px-[10px] max-[518px]:py-[20px]'>
