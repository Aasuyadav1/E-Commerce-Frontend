          ...
          <tbody>
            {cartItems &&
              cartItems.map((cur) => (
                <>
                  ...
                  <td className="border-[#d6d5d5]  border-solid border-[1px] px-4 py-5 mt-4 "  >
                    <div className="flex gap-4 items-center">
                      ...
                      <div className="">
                        <p className="text-xl w-[150px]  text-ellipsis whitespace-nowrap overflow-hidden">{cur.name}</p>
                  ...
                  <td className="border-[#d6d5d5]  border-solid border-[1px] px-4 hidden  lg:table-cell">
                    <p className="text-xl">${cur.afterDiscountamt}</p>
                  </td>
                  <td className="border-[#d6d5d5]  border-solid border-[1px] px-4 hidden  lg:table-cell">
                    <div className="flex gap-6 justify-center items-center text-xl bg-[rgb(242,242,242)] max-w-[150px] w-full overflow-hidden py-2 px-6 rounded-full shadow-md ">
                      ...
                      ></i>
                      <p className="text-lg">{cur.quantity}</p>
                      <i
                ...
                <div className="  lg:hiddenl w-full flex justify-center items-center">
                    <p className="text-xl">${cur.afterDiscountamt}</p>
                  </div>
          ...
          <div>
            ...
            <div className="mt-8">
                <table className="w-full bg-white ">
                  <tr >
                    <td className="border-[#aca9a9] border-solid border-[1px] px-4 py-3 opacity-90 w-[150px]">Subtotal</td>
